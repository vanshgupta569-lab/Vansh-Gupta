...
const METHODOLOGY_STEPS = [
  { step: 'STEP 1', title: 'Open a Ticker', description: 'Search covered companies and open their dashboard. Each company shows a live price, key metrics, and three years of audited reported financials pulled from official filings.', icon: Search, detail: 'Coverage currently spans five companies: AAPL, META, NVDA, RELIANCE, SPCX. More added as models are built and verified.' },
  { step: 'STEP 2', title: 'Read the Reported History', description: 'Three years of income statement, balance sheet and cash flow side by side. Figures are as reported — no adjustments, no estimates, no rounding. Revenue growth, margins, free cash flow and net debt are computed directly from those numbers.', icon: BarChart2, detail: 'Historical data is sourced from SEC filings (US companies) and exchange disclosures (Indian companies). Units are clearly labelled per company.' },
  { step: 'STEP 3', title: 'Inspect the Integrated Model', description: 'A full 3-statement model built on the reported history: income statement, balance sheet, cash flow, working capital schedule, PP&E schedule, debt schedule, and capital stock. Every forecast line is driven by a named assumption, not a black box.', icon: FileSpreadsheet, detail: 'The balance sheet is checked for balance in every year. Forecasts are clearly labelled — reported figures carry an "R" tag, modelled figures carry an "M" tag.' },
